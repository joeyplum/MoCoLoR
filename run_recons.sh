...
run_binning_quantile() {
    $PYTHON_EXECUTABLE binning_hilbert_dynamic.py --fname /storage/Joey/MoCoLoR/data/floret-neonatal-20240202/ --nbins 6 --plot 1 --nprojections 10000 --exc_start 45000 --exc_end 85000
}
...
run_recon_xdgrasp1() {
    $PYTHON_EXECUTABLE recon_xdgrasp_npy.py /storage/Joey/MoCoLoR/data/floret-neonatal-20240202/ --lambda_TV 0.05 --vent_flag 1 --recon_res 117 --scan_res 220
}

# Function to run the recon_mocolor_npy.py script with given arguments
run_recon_mocolor1() {
    $PYTHON_EXECUTABLE recon_lrmoco_vent_npy.py /storage/Joey/MoCoLoR/data/floret-neonatal-20240202/ --use_dcf 2 --lambda_lr 0.025 --recon_res 117 --scan_res 220 --mr_cflag 1 --res_scale 0.75 
}

# Function to run the recon_xdgrasp_npy.py script with given arguments
run_recon_nufft() {
    $PYTHON_EXECUTABLE recon_dcf_nufft_npy.py /storage/Joey/MoCoLoR/data/floret-neonatal-20240202/ --lambda_TV 0 --vent_flag 0 --recon_res 117 --scan_res 220
}

# Generate a mask
run_segmentation() {
    $PYTHON_EXECUTABLE segmentation/segmentation_ute.py --fname /storage/Joey/MoCoLoR/data/floret-neonatal-20240202/results/ --filename img_mocolor_10_bin_117_resolution.nii --plot 0 --mask 1
}
