...
run_binning_quantile() {
    $PYTHON_EXECUTABLE binning_hilbert_dynamic.py --fname /storage/Joey/MoCoLoR/data/floret-740H-038c/ --nbins 20 --plot 1 --nprojections 12000 
}

# TODO: 314v3, 403, 402(ovid), 406v4(pretty), 477(BOS)

# Function to run the recon_xdgrasp_npy.py script with given arguments
run_recon_xdgrasp1() {
    $PYTHON_EXECUTABLE recon_xdgrasp_npy.py /storage/Joey/MoCoLoR/data/floret-740H-038c/ --lambda_TV 0.05 --vent_flag 1 --recon_res 117 --scan_res 220
}

# Function to run the recon_mocolor_npy.py script with given arguments
run_recon_mocolor1() {
    $PYTHON_EXECUTABLE recon_lrmoco_vent_npy.py /storage/Joey/MoCoLoR/data/floret-740H-038c/ --mr_cflag 1 --use_dcf 2 --lambda_lr 0.025 --recon_res 117 --scan_res 220 --res_scale 0.75 
}

# Function to run the recon_xdgrasp_npy.py script with given arguments
run_recon_nufft() {
    $PYTHON_EXECUTABLE recon_dcf_nufft_npy.py /storage/Joey/MoCoLoR/data/floret-740H-038c/ --lambda_TV 0 --vent_flag 0 --recon_res 160 --scan_res 300
}

# Generate a mask
run_segmentation() {
    $PYTHON_EXECUTABLE segmentation/segmentation_ute.py --fname /storage/Joey/MoCoLoR/data/floret-740H-038c/results/ --filename img_mocolor_20_bin_480mm_FOV_3mm_recon_resolution.nii --plot 0 --mask 1
}
