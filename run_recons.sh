...
run_binning_quantile() {
    $PYTHON_EXECUTABLE binning_hilbert_dynamic.py --fname data/floret-186H-496/ --nbins 24 --plot 1 --nprojections 10000 
}
...
run_recon_xdgrasp() {
    $PYTHON_EXECUTABLE recon_xdgrasp_npy.py data/floret-186H-496/ --lambda_TV 0.05 --vent_flag 1 --recon_res 117 --scan_res 220
}

# Function to run the recon_mocolor_npy.py script with given arguments
run_recon_mocolor() {
    $PYTHON_EXECUTABLE recon_lrmoco_vent_npy.py data/floret-186H-496/ --rho 1 --method 'cg' --gamma 1 --jsense 2 --use_dcf 3 --lambda_lr 0.0075 --recon_res 117 --scan_res 220 --res_scale 0.75 --iner_iter 5 --outer_iter 3 --init_iter 10
}

# Default MoCoLoR settings
run_recon_mocolor_default() {
    $PYTHON_EXECUTABLE recon_lrmoco_vent_npy.py data/floret-186H-496/ --rho 1 --method 'gm' --gamma 0 --jsense 1 --use_dcf 2 --lambda_lr 0.025 --recon_res 117 --scan_res 220 --res_scale 0.75 --iner_iter 5 --outer_iter 3 --init_iter 0
}

# Function to run the recon_xdgrasp_npy.py script with given arguments
run_recon_nufft() {
    $PYTHON_EXECUTABLE recon_dcf_nufft_npy.py data/floret-186H-496/ --vent_flag 0 --recon_res 117 --scan_res 220
}

# Generate a mask
run_segmentation() {
    $PYTHON_EXECUTABLE segmentation/segmentation_ute.py --fname data/floret-186H-496/results/ --filename img_mocolor_cg_24_bin_480mm_FOV_3mm_recon_resolution.nii --plot 0 --mask 1
}
