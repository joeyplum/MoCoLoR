...
run_binning_quantile() {
    $PYTHON_EXECUTABLE binning_hilbert_dynamic.py --fname /storage/Joey/MoCoLoR/data/floret-803H-043/ --nbins 24 --plot 1 --nprojections 10000 --reorder 2 
}

# Function to run the recon_xdgrasp_npy.py script with given arguments
run_recon_xdgrasp() {
    $PYTHON_EXECUTABLE recon_xdgrasp_npy.py /storage/Joey/MoCoLoR/data/floret-803H-043/ --lambda_TV 0.05 --vent_flag 1 --recon_res 117 --scan_res 220
}
